          ...
          <div className="flex mt-24 flex-row col-lg-12 col-md-12 col-sm-12">
            {(nfts as any).map((nft: any, i: number) => {
              ...
              <>
                ...
                {/* {showDetail[selectedIndex] &&<SweetAlert
                  style={{position: "relative", margin: "auto"}}
                  title="GENISIS COLLECTION"
                  onConfirm={() => hideAlert(selectedIndex)}
                  btnSize="sm"
                  // timeout={2000}
                  closeOnClickOutside
                  // openAnim={{ name: 'COLLECTION', duration: 2000 }}
                  // closeAnim={{ name: 'COLLECTION', duration: 2000 }}
                >
                  {selectedDescription}
                  </SweetAlert>
                } */}
